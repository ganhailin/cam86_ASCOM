...
; Generated by Tinylib on 2022/10/3 (UTC)
;
[Setup]
AppID={{66626de8-bd6b-42a1-9b9f-fbd7092c4221}
AppName=ASCOM cam86 Camera Driver
AppVerName=ASCOM cam86 Camera Driver 0.9.0
AppVersion=0.9.0
AppPublisher=Tinylib <3dgans@outlook.com>
AppPublisherURL=mailto:3dgans@outlook.com
...
OutputDir="."
OutputBaseFilename="cam86 Setup"
Compression=lzma
